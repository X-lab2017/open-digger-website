...
<SimpleECharts divStyle={{ height: '350px' }} option={{
  ...
  series: [
    ...
    { name: 'Valkey-OpenRank', type: 'bar', data: [0,0,0,0,0,29.33,52.74,61.11,66.41,61.91,53.2,55.71,64.46,71.3,75.27], itemStyle: { color: 'red' } },
    { name: 'Redis-Participant', type: 'bar', yAxisIndex: 1, data: [102,101,100,104,94,220,92,75,60,65,69,76,67,54,47], itemStyle: { color: 'yellow' } },
    { name: 'Valkey-Participant', type: 'bar', yAxisIndex: 1, data: [0,0,0,0,0,146,120,92,62,57,54,68,73,79,78], itemStyle: { color: 'green' } },
  ]
}} />
